...
pros::Motor firstStage(-12, pros::v5::MotorGears::green, pros::v5::MotorUnits::degrees);  // First stage motor
pros::v5::Motor secondStage(6, pros::v5::MotorGears::blue);                               // Second stage motor
